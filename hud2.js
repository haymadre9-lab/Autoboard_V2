...
export function createHud2(canvas, opts = {}){
  ...
  const cfgOpt = Object.assign({
    ...
    rotondaInvertida: false, // si la isla sale al lado equivocado, ponlo a true
  ...
  const api = {};
  api.onError = null;
  api.version = '2026.08.31-7';   // sube al cambiar: sirve para saber qué está corriendo
  ...
  function detectRoundabouts(){
    ...
    for (const r of runs){
      ...
      // La isla va al lado hacia el que curva el trazado. En España se circula
      // en sentido antihorario, asi que la isla queda a tu IZQUIERDA. Si en tu
      // pantalla sale al otro lado, invierte con rotondaInvertida.
