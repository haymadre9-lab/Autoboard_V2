...
export function createHud2(canvas, opts = {}){
  ...
  const api = {};
  api.onError = null;
  api.version = '2026.09.01-4';   // sube al cambiar: sirve para saber qué está corriendo
  let carImg = null, carAR = 1;
  let manOver = null, limitOver = null, radarOver = null, streetOver = null;
  let fuera = 0, finAvisado = false;
  api.onFinRuta = null;
  ...
  api.setRoute = function(latlngs, o = {}){
    ...
    fuera = 0; finAvisado = false; cam0.off = null; cam0.yaw = null;
  ...
  function frame(now){
    ...
    s = clamp(s + speed*dt, 0, routeLen + 5000);
